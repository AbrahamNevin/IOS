...
func getMeal (_mealName: String ) -> Meal? {
    return meals[_mealName]
}
if let breakfast = getMeal( _mealName: "Breakfast") {
    print("Breakfast: \(breakfast.food), Calories: \(breakfast.calories)")
}
else {
    print("No breakfast logged yet.")
}
if let lunch = getMeal( _mealName: "Lunch") {
