...
//The error is Value of optional type 'Int?' must be unwrapped to a value of type 'Int'
...
print(userAge)
//the error message is Expression implicitly coerced from 'Int?' to 'Any'
//userAge is nil because the string "34e" cannot be converted into a valid integer
