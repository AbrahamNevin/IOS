...
print("The postion of the ship is \(destroyer.position)")
destroyer.moveRight()
print("The new position is \(destroyer.position)")
...
destroyer.fire()
destroyer.fire()
print("The remaining firepower is: \(destroyer.remainingFirePower)")
