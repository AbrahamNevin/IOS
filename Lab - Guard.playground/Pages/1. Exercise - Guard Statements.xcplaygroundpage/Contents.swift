...
if let positiveArea = calculateArea(x: 5.0, y: 3.0) {
    ...
    print("Invalid input for positive numbers")
}

if let negativeArea = calculateArea(x: -5.0, y: 3.0) {
    print("Area with negative numbers: \(negativeArea)")
} else {
    print("Invalid input for negative numbers")
}
...
if let sum1 = add(10, 20) {
    print("Sum with non-nil numbers: \(sum1)")
} else {
    print("Invalid input with non-nil numbers")
}

if let sum2 = add(nil, 5) {
    print("Sum with nil parameter: \(sum2)")
} else {
    print("Invalid input with nil parameter")
}
...
if let result1 = add1(7, 8) {
    print("Sum with non-nil numbers: \(result1)")
} else {
    print("Invalid input with non-nil numbers")
}

if let result2 = add1(nil, 10) {
    print("Sum with nil parameter: \(result2)")
} else {
    print("Invalid input with nil parameter")
}
