...
var favouriteBook = Book (title:"Harry Potter", author:"JK Rowling", pages: 342, price : 350 )
...
let macBookPro = Laptop(yearPurchased : 2023)
let windowsHp = Laptop (screenSize : 10 , repairCount : 2, yearPurchased : 2020)
print(macBookPro.screenSize, macBookPro.repairCount, macBookPro.yearPurchased)
print(windowsHp.screenSize, windowsHp.repairCount, windowsHp.yearPurchased)
/*:
...
struct Height {
    ...
    let heightOne = Height(inches: 65)
    let heighTwo = Height(centimeters: 165.1)
...
var myHeight = Height (centimeters : 160)
print(myHeight.heightInInches)

var myHeight2 = Height (inches : 62.999999999999996)
