...
print("Initial cm : \(myHeight.heightInCentimeters)")
myHeight.heightInCentimeters = 180.0
print("Updated inches : \(myHeight.heightInInches)")
myHeight.heightInInches = 65
print("Updated centimeters : \(myHeight.heightInCentimeters)")
