...
var userOne = User(name: "Ayaana", age: 20, height: 160, weight: 55, activityLevel: 7)
print ("Hello my name is \(userOne.name)")
print ("I am \(userOne.age) years old")
print("My height is \(userOne.height) and weight is \(userOne.weight) and my activity level is \(userOne.activityLevel)")
/*:
...
let oneMile = Distance(meters: 1600)
print(oneMile.feet)

//:  Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
let twoMile = Distance (feet: 5249.344)
