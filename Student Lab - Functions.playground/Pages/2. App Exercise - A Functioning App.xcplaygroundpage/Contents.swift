...
incrementSteps()  // Prints: Steps: 1
incrementSteps()  // Prints: Steps: 2
incrementSteps()  // Prints: Steps: 3
...
// Example usage:
steps = 500
progressUpdate()   // Prints: You're off to a good start.

steps = 4000
progressUpdate()   // Prints: You're almost halfway there!

steps = 8000
progressUpdate()   // Prints: You're over halfway there!

steps = 9500
progressUpdate()   // Prints: You're almost there!

steps = 12000
progressUpdate()   // Prints: You beat your goal!
