...
//the variable `foo` is declared inside the for-loop’s scope and is therefore not accessible outside the loop.
...
// x is declared out of the for loop hence can be used
